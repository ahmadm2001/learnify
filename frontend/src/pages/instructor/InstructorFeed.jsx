...
function EmptyFeedState({ onCreate }) {
  return (
    ...
    >
      ...
      <Typography variant="h6" sx={{ fontWeight: 800, color: palette.dark, mb: 1 }}>
        No posts yet
      </Typography>

      <Typography sx={{ color: palette.textMuted, maxWidth: 420, mx: "auto", mb: 3 }}>
        Start sharing course updates, ideas, announcements, or insights with your learners.
      </Typography>
...
export default function InstructorFeed() {
  ...
  const [commentMenuCtx, setCommentMenuCtx] = useState(null); // { postId, commentId } or null
  ...
  const removePreviewImage = (imgObj) => {
    ...
    if (imgObj.id) {
      setRemovedImageIds((prev) => (prev.includes(imgObj.id) ? prev : [...prev, imgObj.id]));
      return;
    }
  ...
  useEffect(() => {
    ...
    const onKey = (e) => {
      ...
      if (viewerImages.length > 1 && (e.key === "ArrowLeft" || e.key === "ArrowRight")) {
        e.preventDefault();
          ...
          >
            <Box>
              ...
              <Typography sx={{ color: palette.textMuted }}>
                Share updates, ideas and insights with your learners
              </Typography>
            </Box>

            <Chip
              icon={<AutoAwesomeOutlinedIcon />}
              label="Professional Feed"
              sx={{
        ...
        >
          <CardContent sx={{ p: { xs: 2, md: 2.5 } }}>
            ...
            >
              ...
              <Stack direction="row" spacing={1} alignItems="center">
                <EditOutlinedIcon fontSize="small" sx={{ color: palette.primary }} />
                <Typography variant="body2" fontWeight={600}>
                  Write article
                </Typography>
              </Stack>
        ...
        >
          <DialogContent sx={{ p: { xs: 2, md: 3 } }}>
            ...
            <Box display="flex" justifyContent="flex-end" mt={3}>
              <Button
                variant="contained"
                disabled={posting || (!text.trim() && images.length === 0 && !isEditing)}
            ...
            >
              <CardContent sx={{ p: { xs: 2, md: 2.5 } }}>
                ...
                <Box sx={{ display: "flex", justifyContent: "space-around", gap: 1 }}>
                  <Button
                    startIcon={
                      post.liked_by_me ? <ThumbUpIcon fontSize="small" /> : <ThumbUpOutlinedIcon fontSize="small" />
                    }
                    ...
                    sx={{
                      ...
                      bgcolor: post.liked_by_me ? "rgba(124,58,237,0.08)" : "transparent",
                      "&:hover": {
                  ...
                  <Button
                    ...
                    sx={{
                      ...
                      py: 1,
                      borderRadius: 2.5,
                      color: openComments === post.id ? palette.primary : palette.textMuted,
                      bgcolor: openComments === post.id ? "rgba(124,58,237,0.08)" : "transparent",
                      "&:hover": {
                        bgcolor: "rgba(124,58,237,0.08)",
                      },
                    }}
                      ...
                      {commentsLoading[post.id] ? (
                        ...
                        <Stack spacing={1.6}>
                          {(comments[post.id] || []).map((c) => {
                            const isMine =
                              (c.user_name || "").toLowerCase() === myUsername.toLowerCase();
                                ...
                                <Box sx={{ flex: 1 }}>
                                  ...
                                  >
                                    <Stack
                                      ...
                                      spacing={1}
                                    >
                                      <Typography variant="body2" fontWeight={800} color={palette.dark}>
                                        {c.user_name}
                                      </Typography>
                                      ...
                                      {isMine && (
                                        <IconButton
                                          ...
                                          onClick={(e) => openCommentMenu(e, post.id, c.id)}
                                        >
